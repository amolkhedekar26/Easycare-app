 ...
 * {@link MyHomeFragment.OnFragmentInteractionListener} interface
...
public class MyHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.original_fragment_home_, container, false);
        
        /*MaterialCardView cardView=view.findViewById(R.id.hospitalcard);
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fragment=new MyHomeFragment();
                TextView textView=getActivity().findViewById(R.id.textView);
                textView.setText("sbhca");
